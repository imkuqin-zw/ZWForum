...
class PermissionsTableSeeder extends Seeder
{
    public function run()
    {
        DB::table('permissions')->insert([
            ...
            ['name'=>'edit-user', 'display_name' => '编辑用户', 'description' => '编辑已有用户的信息','type'=>'user'],
            ...
            ['name'=>'edit-role', 'display_name' => '编辑角色', 'description' => '编辑已有角色的信息','type'=>'role'],
            ...
            ['name'=>'edit-cate', 'display_name' => '编辑分类', 'description' => '编辑已有分类的信息','type'=>'cate'],
            ...
            ['name'=>'edit-tag', 'display_name' => '编辑标签', 'description' => '编辑已有标签的信息','type'=>'tag'],
            ...
            ['name'=>'edit-topic', 'display_name' => '编辑话题', 'description' => '编辑已有话题的信息','type'=>'topic'],
