...
Component.options.__file = "D:\\wamp64\\www\\ZWForum\\resources\\assets\\js\\views\\categorys\\Edit.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0e50b582", Component.options)
  } else {
    hotAPI.reload("data-v-0e50b582", Component.options)
  }
})()}
    ...
    methods: {
        validateBeforeSubmit: function validateBeforeSubmit() {
            ...
            this.$validator.validateAll().then(function (success) {
                ...
                axios.put(window.Domain + 'api/admin/cate/' + _this.$route.params.cateId, _this.formData).then(function (response) {
        ...
        getTagInfo: function getTagInfo() {
            ...
            axios.get(window.Domain + 'api/admin/cate/' + this.$route.params.cateId).then(function (response) {
                var data = response.data.data;
                _this2.formData.name = data.name;
                _this2.formData.order = data.order;
                _this2.formData.is_blocked = data.is_blocked;
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-0e50b582", module.exports)
  }
}
...
var update = __webpack_require__(3)("14550292", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-0e50b582!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Edit.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-0e50b582!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Edit.vue");
