...
Component.options.__file = "D:\\wamp64\\www\\ZWForum\\resources\\assets\\js\\views\\users\\Edit.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-d172e9e2", Component.options)
  } else {
    hotAPI.reload("data-v-d172e9e2", Component.options)
  }
})()}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_multiselect__ = __webpack_require__(136);
...
/* harmony default export */ __webpack_exports__["default"] = {
    ...
    methods: {
        ...
        getUserInfo: function getUserInfo() {
            ...
            axios.get(window.Domain + 'api/admin/user/' + this.$route.params.userId).then(function (response) {
                var data = response.data.data;
                _this2.formData.name = data.name;
                _this2.formData.is_banned = data.is_banned;
                _this2.formData.is_admin = data.is_admin;
                _this2.formData.github_name = data.github_name;
                _this2.formData.description = data.description;
                _this2.formData.real_name = data.real_name;
                _this2.formData.city = data.city;
                _this2.formData.company = data.company;
                _this2.formData.weibo_name = data.weibo_name;
                _this2.formData.weibo_link = data.weibo_link;
                _this2.formData.twitter_account = data.twitter_account;
                _this2.formData.personal_website = data.personal_website;
                if (data.portrait_max) _this2.portrait = window.Domain + 'uploads/portraits/' + data.portrait_max;
                _this2.selectedRoles = data.roles.data;
            }).catch(function (error) {
                console.log(error);
            });
        },
        ...
        showImage: function showImage(file) {
            ...
            reader.onload = function (e) {
                _this4.portrait = e.target.result;
                _this4.formData.portrait = e.target.result;
            };
        }
    }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('section', {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.formData.twitter_account),
      expression: "formData.twitter_account"
    }],
    staticClass: "form-control",
    attrs: {
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.formData.twitter_account = $event.target.value
      }
    }
  })]), _vm._v(" "), _c('div', {
    staticClass: "col-sm-4 help-block"
  ...
  })])])])]), _vm._v(" "), _c('hr'), _vm._v(" "), _vm._m(1)])])])], 1)
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-d172e9e2", module.exports)
  }
}
...
var update = __webpack_require__(3)("25163b82", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-d172e9e2!../../../../../node_modules/sass-loader/index.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Edit.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-d172e9e2!../../../../../node_modules/sass-loader/index.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Edit.vue");
