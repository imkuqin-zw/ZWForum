    ...
    <ul class="list-group">
        ...
        <a  href="{{route('user.votesList',$user->id)}}" class="@if($userMenu == 'vote') active @endif">
            <li style="border-bottom: none !important;" class="list-group-item">
                <i class="glyphicon glyphicon-thumbs-up"></i>&nbsp;&nbsp;&nbsp;Ta 赞过的话题
            </li>
        </a>
    </ul>
</div>