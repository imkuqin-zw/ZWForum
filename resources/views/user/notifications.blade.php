        ...
        <div class="col-md-3 user-show border-color">
            <div class="panel panel-body text-center">
                ...
                <a href="{{route('user.notifications')}}" >
                    <li class="list-group-item active"><span>话题通知&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></li>
                </a>
                <a href="{{route('user.mentions')}}" >
                    <li class="list-group-item ">
                    <span>提及到我 <span class="badge" @if($mentionsCount)style="background-color: #d15b47"@endif  >{{  $mentionsCount }}</span></span>
                    </li>
                </a>
                </ul>
            </div>
