            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <ul class="list-inline topic-filter"  >
                        <li data-toggle="tooltip" data-original-title="最后回复排序"  title=""><a  href="{{route('topic.index',['filter'=>'default'])}}" @if($filter == 'default')class="active"@endif >活跃</a></li>
                        <li data-toggle="tooltip" data-original-title="只看加精的话题" title=""><a href="{{route('topic.index',['filter'=>'excellent'])}}" @if($filter == 'excellent')class="active"@endif  >精华</a></li>
                        <li data-toggle="tooltip" data-original-title="点赞数排序" title=""><a href="{{route('topic.index',['filter'=>'vote'])}}" @if($filter == 'vote')class="active"@endif  >投票</a></li>
                        <li data-toggle="tooltip" data-original-title="发布时间排序" title=""><a href="{{route('topic.index',['filter'=>'recent'])}}" @if($filter == 'recent')class="active"@endif  >最近</a></li>
                        <li data-toggle="tooltip" data-original-title="无人问津的话题" title=""><a href="{{route('topic.index',['filter'=>'noreply'])}}" @if($filter == 'noreply')class="active"@endif  >零回复</a></li>
                    </ul>
                    <div class="clearfix"></div>
                </div>
                <div class="jscroll">
                    <div class="jscroll-inner">
                        @if(count($topTopics) || count($topics))
                        <div class="panel-body remove-padding-horizontal">
                            <ul class="list-group row topic-list">
                                @foreach($topTopics as $topTopic)
                                <li class="list-group-item ">
                                    <a class="reply_count_area hidden-xs pull-right" href="{{route('topic.show',$topTopic->id)}}">
                                        <div class="count_set">
                                            <span data-toggle="tooltip" class="count_of_votes" title="投票数">{{$topTopic->vote_count}}</span>
                                            <span data-toggle="tooltip" class="count_seperator">/</span>
                                            <span data-toggle="tooltip" class="count_of_replies" title="回复数">{{$topTopic->reply_count}}</span>
                                            <span data-toggle="tooltip" class="count_seperator">/</span>
                                    ...
                                    <div class="infos">
                                        <div class="media-heading">
                                            ...
                                            <a href="{{route('topic.show',$topTopic->id)}}" title="{{$topTopic->title}}">
                                                {{$topTopic->title}}
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <li class="list-group-item ">
                                    <a class="reply_count_area hidden-xs pull-right" href="{{route('topic.show',$topic->id)}}">
                                        <div class="count_set">
                                            ...
                                            <span data-toggle="tooltip" class="count_seperator">|</span>
                                            <abbr data-toggle="tooltip" title="{{$topic->created_at}}"  data-original-title="{{$topic->created_at}}">{{$topic->created_at->diffForHumans()}}</abbr>
                                        </div>
                                    </a>
                                    <div class="avatar pull-left">
