    ...
    <div class="container main-container">
        ...
        <div class="col-md-8">
            <form method="POST" action="{{route('topic.store')}}">
                ...
                <div class="form-group">
                    <input class="form-control" autocomplete=off id="topic-title" placeholder="请填写标题" name="title" type="text" value="" required="require">
                </div>
                <textarea name="content" placeholder="请使用 Markdown 格式书写 ;-)，代码片段黏贴时请注意使用高亮语法。" id="message-editable"></textarea>
                <div class="form-group">
