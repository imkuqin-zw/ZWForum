            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <ul class="list-inline topic-filter"  >
                        <li data-toggle="tooltip" data-original-title="最后回复排序"  title=""><a  href="{{route('tag.show',[$tag, 'filter'=>'default'])}}" @if($filter == 'default')class="active"@endif >活跃</a></li>
                        <li data-toggle="tooltip" data-original-title="只看加精的话题" title=""><a href="{{route('tag.show',[$tag, 'filter'=>'excellent'])}}" @if($filter == 'excellent')class="active"@endif  >精华</a></li>
                        <li data-toggle="tooltip" data-original-title="点赞数排序" title=""><a href="{{route('tag.show',[$tag, 'filter'=>'vote'])}}" @if($filter == 'vote')class="active"@endif  >投票</a></li>
                        <li data-toggle="tooltip" data-original-title="发布时间排序" title=""><a href="{{route('tag.show',[$tag, 'filter'=>'recent'])}}" @if($filter == 'recent')class="active"@endif  >最近</a></li>
                        <li data-toggle="tooltip" data-original-title="无人问津的话题" title=""><a href="{{route('tag.show',[$tag, 'filter'=>'noreply'])}}" @if($filter == 'noreply')class="active"@endif  >零回复</a></li>
                    </ul>
