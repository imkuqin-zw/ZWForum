                ...
                <div class="tab-content container-fluid">
                    <div class="tab-pane active" id="tab_1" >
                        ...
                        <div class="form-group" :class="{ 'has-error': errors.has('password') }" >
                            ...
                            <div class="col-sm-9 col-md-6">
                                <input class="form-control" id="password" name="password" v-model='formData.password' v-validate:password.initial="'min:6'"  type="password" placeholder="">
                    ...
                    <div class="tab-pane" id="tab_2" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" v-model='formData.twitter_account' name="formData.twitter_account" type="text" value="">
                            </div>
                            <div class="col-sm-4 help-block">
                                如：summer_charlie
                            </div>
...
<script type="javascript">
 ...
 export default {
    ...
    methods: {
        ...
        getUserInfo(){
            axios.get(window.Domain + 'api/admin/user/' + this.$route.params.userId)
                .then(response => {
                    let data = response.data.data
                    this.formData.name = data.name
                    this.formData.is_banned = data.is_banned
                    this.formData.is_admin = data.is_admin
                    this.formData.github_name =data.github_name
                    this.formData.description =data.description
                    this.formData.real_name =data.real_name
                    this.formData.city =data.city
                    this.formData.company =data.company
                    this.formData.weibo_name =data.weibo_name
                    this.formData.weibo_link =data.weibo_link
                    this.formData.twitter_account =data.twitter_account
                    this.formData.personal_website =data.personal_website
                    if(data.portrait_max)
                      this.portrait = window.Domain+'uploads/portraits/'+data.portrait_max
                    this.selectedRoles = data.roles.data
