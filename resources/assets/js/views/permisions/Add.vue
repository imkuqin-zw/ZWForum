                    ...
                    <div class="tab-pane active" id="tab_1" >
                        ...
                        <div class="form-group" :class="{ 'has-error': errors.has('name') }" >
                            ...
                            <div class="col-sm-9 col-md-6">
                                <input class="form-control" id="name" name="name" v-model='formData.name' v-validate:name.initial="'required'"  type="text" >
    ...
    methods: {
        validateBeforeSubmit() {
            this.$validator.validateAll().then(success => {
                ...
                axios.post(window.Domain + 'api/admin/role',this.formData)
                    .then(response => {
